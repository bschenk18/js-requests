...
let request = axios.get(`http://localhost:3000/repeat/Hello-World`)
request.then(res => console.log(res.data))
let repeatWord = document.getElementById(`repeat-text`)
    repeatWord.textContent = request
    repeatWord.display = `block`
}
...
// CODE HERE
function queryTest() {
axios.get('http://localhost:3000/query-test?Lions')
